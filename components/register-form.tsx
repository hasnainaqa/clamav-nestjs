      ...
      <Card className="border-border shadow-none">
        <CardContent className="pt-6">
          <Button
            type="button"
            variant="outline"
            className="w-full h-11 mb-6 border-border hover:bg-muted/50 transition-colors bg-transparent"
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className="h-11 bg-input border-border focus:ring-primary/20 transition-all"
              />
            </div>
